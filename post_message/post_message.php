...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $dbc = mysqli_connect('localhost', 'root', 'youngboy86', 'forum');
  ...
  //Print message based upon the result:
  if(mysqli_stmt_affected_rows($stmt) == 1){
     echo '<p>Your message has been posted.</p>';
  
  }else{
     echo '<p style="font-weight: bold;
	        color: #C00">Your message could not be posted.</p>';
